...
_Generated: 2026-07-06T04:22:07+00:00_
...
| Mean latency        | 6395 ms |
| Mean cost / doc     | $0.062903 |
| Total cost          | $0.3145 |
| Wall time           | 32.08 s |
...
| `cover.fiscal_year_end` | date | 5 | 0.800 | 0.800 | 0.800 |
| `cover.form_type` | text | 5 | 0.800 | 0.800 | 0.800 |
...
| `financials.revenue` | number | 5 | 0.667 | 0.400 | 0.500 |
| `financials.eps_basic` | number | 5 | 1.000 | 0.200 | 0.333 |
| `financials.eps_diluted` | number | 5 | 1.000 | 0.200 | 0.333 |
| `financials.cash_and_equivalents` | number | 5 | 0.500 | 0.200 | 0.286 |
| `financials.total_equity` | number | 5 | 0.500 | 0.200 | 0.286 |
| `financials.net_income` | number | 5 | 0.333 | 0.200 | 0.250 |
| `cover.filing_date` | date | 5 | 0.000 | 0.000 | 0.000 |
| `financials.total_debt` | number | 5 | 0.000 | 0.000 | 0.000 |
| `financials.cost_of_revenue` | number | 3 | 0.333 | 0.333 | 0.333 |
| `financials.operating_income` | number | 2 | 1.000 | 1.000 | 1.000 |
| `financials.gross_profit` | number | 1 | 0.500 | 1.000 | 0.667 |
